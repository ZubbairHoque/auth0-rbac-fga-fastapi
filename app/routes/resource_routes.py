...
async def list_resources(
    ...
    allowed_ids = await authz_service.get_user_resources(user_id)
...
async def get_resource(
    ...
    if not await authz_service.check_permission(user_id, "can_view", resource_id):
...
async def create_resource(
    ...
    if not await authz_service.check_permission(user_id, "can_create_resource"):
    ...
    await authz_service.link_resource_to_system(resource_id)
...
async def delete_resource(
    ...
    if not await authz_service.check_permission(user_id, "can_delete", resource_id):
